            ...
            <div className="home-user-logued-background">
                ...
                <div className="home-user-logued-content mt-5">
                    ...
                    <section className="home-user-logued-active-section">
                        ...
                        <div className="home-user-logued-scroll-container">
                            <div className="home-user-logued-scroll">
                                {store.surveys
                                    .filter(survey => store.user && survey.creator_id === store.user.id)
                                    .map((survey, index) => (
                                        <div key={index} className="col-12 col-lg-6 mb-4">
                                            <div className="home-user-logued-large-card card shadow-sm border-0">
                                                ...
                                                <div className="home-user-logued-card-body card-body">
                                                    <h4 className="home-user-logued-card-title mb-3">{survey.title}</h4>
                                                    <p className="home-user-logued-card-text mb-2">{survey.description}</p>
                                                    <p className="home-user-logued-card-text mb-2"><strong>Status:</strong> <span className="home-user-logued-active-badge badge">{survey.status}</span></p>
                        ...
                        <button className="home-user-logued-all-surveys-scroll-btn btn mt-3" onClick={() => navigate(`/surveys/created/${store.user?.id}`)}>View All Created Surveys</button>
                    </section>
                    ...
                    <section className="home-user-logued-popular-section mt-5">
                        ...
                        <button className="home-user-logued-all-surveys-scroll-btn btn mt-3" onClick={() => navigate('/surveys')}>View All Surveys</button>
                    </section>
                </div>
            </div>
        </div>
